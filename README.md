...
A web-based demo for generating tabular Question-Answering benchmarks, powered by [Gradino](https://github.com/softlab-unimore/Gradino). Built for the Submitted to CIKM 2026 conference demo track.
